...
{
    [DbContext(typeof(VendaCapDbContext))]
    [Migration("20220803211539_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VendaCap.Common.Person", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("VendaCap.Common.Place", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int?>("PlaceParentId")
                        .HasColumnType("integer");

                    b.HasKey("Id");

                    b.HasIndex("PlaceParentId");

                    b.ToTable("AppPlaces", (string)null);
                });

            modelBuilder.Entity("VendaCap.Common.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("VendaCap.Common.TicketSet", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppTicketSets", (string)null);
                });
            ...
            modelBuilder.Entity("VendaCap.Common.Person", b =>
                {
                    ...
                    b.HasOne("VendaCap.Common.Place", "Place")
                        .WithMany()
            ...
            modelBuilder.Entity("VendaCap.Common.Place", b =>
                {
                    b.HasOne("VendaCap.Common.Place", "PlaceParent")
                        .WithMany()
                        .HasForeignKey("PlaceParentId");

                    b.Navigation("PlaceParent");
                });

            modelBuilder.Entity("VendaCap.Common.TicketSet", b =>
                {
                    b.HasOne("VendaCap.Common.Product", "Product")
                        .WithMany()
