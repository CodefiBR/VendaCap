        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IbgeCode = table.Column<string>(type: "text", nullable: true),
                    BacenCode = table.Column<string>(type: "text", nullable: true),
                    PlaceParentId = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppPlaces", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppPlaces_AppPlaces_PlaceParentId",
                        column: x => x.PlaceParentId,
                        principalTable: "AppPlaces",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AppPeople_AppPlaces_PlaceId",
                        column: x => x.PlaceId,
                        principalTable: "AppPlaces",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppTicketSets", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppTicketSets_Product_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppPeople_PlaceId",
                table: "AppPeople",
                column: "PlaceId");

            migrationBuilder.CreateIndex(
                name: "IX_AppPlaces_PlaceParentId",
                table: "AppPlaces",
                column: "PlaceParentId");

            migrationBuilder.CreateIndex(
                name: "IX_AppTicketSets_ProductId",
                table: "AppTicketSets",
                column: "ProductId");
