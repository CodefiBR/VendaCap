...
public class VendaCapEntityFrameworkCoreModule : AbpModule
{
    ...
    {
        context.Services.AddAbpDbContext<VendaCapDbContext>(options =>
        {
        ...
        Configure<AbpDbContextOptions>(options =>
        {
                 ...
                 * See also VendaCapMigrationsDbContextFactory for EF Core tooling. */
            options.UseNpgsql();
        });
    }
}
